...
@section('page_name',__('Blog'))

@section('page_description',__('Blog'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Blog') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('admin.blogs.update',encrypt($blog->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
