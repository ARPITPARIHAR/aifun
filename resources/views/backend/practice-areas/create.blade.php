            ...
            <div class="card-block">
                <form action="{{ route('admin.practice_areas.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="position" id="position" value="{{ old('position')}}" placeholder="{{ __('Enter Position') }}" class="form-control @error('position') form-control-danger @enderror">
                           <span class="messages">
                                @error('position')
                                    <p class="text-danger error">{{ $message }}</p>
                                @else
